        ...
        formUsuario.onsubmit = function(e) {
            ...
            request.onreadystatechange = function() {
                if (request.readyState == 4) {
                    divLoading.style.display = "none";  // Ocultar el loading después de obtener la respuesta
                    if (request.status == 200) {
                        try {
                            // Mostrar la respuesta para verificar si es JSON
                            ...
                            swal("Error", "Hubo un problema con la respuesta del servidor. Revisa la consola.", "error");
                        }
                    } else {
