...
<script>
	function showQRCode(qrImage) {
		console.log("showQRCode called with image:", qrImage); // Depuración
		var qrModal = document.getElementById('Modalqr');
		var qrImg = document.getElementById('qr-image');
		var span = document.getElementsByClassName('qrclose')[0];

		qrImg.src = '<?= media() ?>/images/' + qrImage;
	...
	console.log("JavaScript initialized"); // Depuración
...
<!-- Contenedor principal del modalqr -->
<div class="modal fade" id="modalqr1" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">QR Nequi</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
...
<div class="modal fade" id="modalqr2" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">QR DAVIVIENDA</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
...
<div class="modal fade" id="modalqr3" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">QR BANCOLOMBIA </h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
...
<div class="modal fade" id="modalqr4" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">QR BBVA </h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
										...
										<input type="radio" id="contraentrega" class="methodpago" name="payment-method"
											...
											<div>
												...
												<a href="#" data-toggle="modal" data-target="#modalqr2"> <img
														src="<?= media() ?>/images/icono_davivienda.png" alt="Icono del Banco"
														width="55" height="40"> </a>
												<a href="#" data-toggle="modal" data-target="#modalqr3"> <img
														src="<?= media() ?>/images/icono_bancolombia.png" alt="Icono del Banco"
														width="45" height="30"> </a>
												<a href="#" data-toggle="modal" data-target="#modalqr4"> <img
														src="<?= media() ?>/images/icon_bbva.webp" alt="Icono del Banco" width="74"
														height="20"> </a>
											</div>
									</label>
								</div>
											...
											if (count($data['tiposPago']) > 0) {
												foreach ($data['tiposPago'] as $tipopago) {
													if ($tipopago['idtipopago'] != 1) {
														?>
														<option value="<?= $tipopago['idtipopago'] ?>"><?= $tipopago['tipopago'] ?>
														</option>
														<?php
													}
												}
