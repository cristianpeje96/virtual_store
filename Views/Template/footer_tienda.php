		...
		<div class="container">
			...
			<div class="p-t-40">
				<p class="stext-107 cl6 txt-center">
					...
					&copy; <?= NOMBRE_EMPESA; ?> | <?= WEB_EMPRESA; ?> | <a href="https://colorlib.com" target="_blank">Colorlib</a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
				</p>
			</div>
		</div>
		<div class="whatsapp-icon">
		  <a href="https://wa.me/<?= WHATSAPP ?>"><img src="Assets/tienda/images/WhatsApp_icon.png" alt="WhatsApp"></a>
		</div>
	</footer>
	<!-- Back to top -->
...
<!--===============================================================================================-->
	...
	<script src="<?= media() ?>/js/filtrado.js"></script>
