...
<html lang="es">
  <head>
    ...
    <link rel="shortcut icon" href="<?= media();?>/images/faviconps.ico">
  ...
  <body class="app sidebar-mini">
    ...
    <header class="app-header bg-dark">
      <a class="app-header__logo bg-dark" href="<?= base_url(); ?>/dashboard">
        <img src="<?= media(); ?>/images/logo.png" alt="Tienda Virtual" style="height: 25px;"></a>
      <!-- Sidebar toggle button--><a class="app-sidebar__toggle bg-dark" href="#" data-toggle="sidebar" aria-label="Hide Sidebar"><i class="fas fa-bars">
      </i></a>
      <!-- Navbar Right Menu-->
      <ul class="app-nav">
        <!-- User Menu-->
