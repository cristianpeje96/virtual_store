            ...
            <div class="col-md-4">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" data-live-search="true" id="listCategoria" name="listCategoria"
                    required=""></select>
                </div>
                <div class="form-group col-md-6">
                  <label for="listSubcategoria">Subcategoria<span class="required">*</span></label>
                  <select class="form-control" data-live-search="true" id="listSubcategoria" name="listSubcategoria"
                    required="">
                  </select>
                </div>

                <div class="form-group col-md-6">
                  <label for="listColor">Color <span class="required">*</span></label>
                  <select class="form-control" data-live-search="true" id="listColor" name="listColor"
                    required=""></select>
                  <div id="colorDisplay"
                    style="display: flex; align-items: center; margin-top: 10px; padding: 5px; border: 1px solid #ccc; border-radius: 5px; background-color: #f9f9f9;">
                    <div id="colorBox"
                      style="width: 30px; height: 30px; border: 2px solid #000; margin-right: 10px; border-radius: 4px;">
                    </div>
                    <span id="colorName" style="font-weight: bold; color: #333;">Selecciona un color</span>
                  </div>
                </div>

                <div id="tallaForm" method="post" action="save_product.php">
                  <div class="form-group col-md-6">
                    <label for="listTallas">Tallas <span class="required">*</span></label>
                    <select class="form-control" data-live-search="true" id="listTallas" name="listTallas[]" multiple
                      required>
                      <?php
                      if (isset($data['tallas'])) {
                        foreach ($data['tallas'] as $talla) {
                          echo '<option value="' . htmlspecialchars($talla['idtalla']) . '">' . htmlspecialchars($talla['talla']) . '</option>';
                        }
                      }
                      ?>
                    </select>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <button id="btnActionForm" class="btn btn-primary btn-lg btn-block" type="submit"><i
