  ...
  <section class="login-content">
    ...
    <div class="login-box">
      ...
      <form class="login-form" name="formLogin" id="formLogin" action="">
        ...
        <div class="form-group btn-container bg-dark">
          <button type="submit" class="btn btn-primary btn-block bg-dark"><i class="fas fa-sign-in-alt"></i> INICIAR
            SESIÓN</button>
        </div>
      </form>
      <form id="formRecetPass" name="formRecetPass" class="forget-form" action="">
        ...
        <div class="form-group btn-container">
          <button type="submit" class="btn btn-primary btn-block bg-dark"><i
