								...
								for ($img = 0; $img < count($arrImages); $img++) {
									...
									<div class="item-slick3" data-thumb="<?= $arrImages[$img]['url_image']; ?>">
										<div class="wrap-pic-w pos-relative">
											<img src="<?= $arrImages[$img]['url_image']; ?>"
												alt="<?= $arrProducto['nombre']; ?>">
											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
												href="<?= $arrImages[$img]['url_image']; ?>">
			...
			<div class="col-md-6 col-lg-5 p-b-30">
				<div class="p-r-50 p-t-5 p-lr-0-lg">
					<h4 class="mtext-105 cl2 js-name-detail p-b-14">
						...
						<?= htmlspecialchars($arrProducto['talla']); ?>
						<p>
    					    Color: <?= htmlspecialchars($arrProducto['colores']); ?>
    					    <span style="display: inline-block; width: 20px; height: 20px; background-color: <?= htmlspecialchars($arrProducto['codigo_hex']); ?>; border: 1px solid #000; margin-left: 10px;"></span>
    					</p>
					</h4>
					...
					<div class="flex-w flex-r-m p-b-10">
						<div class="size-204 flex-w flex-m respon6-next">
							<div class="wrap-num-product flex-w m-r-20 m-tb-10">
								...
								<input id="cant-product" class="mtext-104 cl3 txt-center num-product" type="number"
							...
							<button id="<?= openssl_encrypt($arrProducto['idproducto'], METHODENCRIPT, KEY); ?>"
				...
				<div class="flex-w flex-m p-l-100 p-t-40 respon7">
					...
					<a href="https://twitter.com/intent/tweet?text=<?= $arrProducto['nombre'] ?>&url=<?= $urlShared; ?>&hashtags=<?= SHAREDHASH; ?>"
						target="_blank" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100"
						data-tooltip="Twitter">
						<i class="fa fa-twitter"></i>
					</a>

					<a href="https://api.whatsapp.com/send?text=<?= $arrProducto['nombre'] . ' ' . $urlShared ?>"
						target="_blank" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100"
								...
								<div class="block2-txt flex-w flex-t p-t-14">
									...
									<div class="block2-txt-child2 flex-r p-t-3">
										<a href="#"
											...
											pr="1" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2 js-addcart-detail
