	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			...
			<?php if($data['pagina'] > 1){ ?>
				<a href="<?= base_url() ?>/tienda/subcategoria/<?= $data['infoSubcategoria']['idsubcategoria'].'/'.$data['infosubcategoria']['ruta'].'/'.$prevPagina ?>" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04"> <i class="fas fa-chevron-left"></i> &nbsp; Anterior </a>&nbsp;&nbsp;
			<?php } ?>
			<?php if($data['pagina'] != $data['total_paginas']){ ?>
				<a href="<?= base_url() ?>/tienda/subcategoria/<?= $data['infosubcategoria']['idsubcategoria'].'/'.$data['infosubcategoria']['ruta'].'/'.$nextPagina ?>" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04"> Siguiente &nbsp; <i class="fas fa-chevron-right"></i> </a>
			<?php } ?>
			</div>
			<?php 
				}
